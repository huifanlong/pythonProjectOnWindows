...
df_reflections = pd.read_excel("../mydata/processed/sorted_reflection.xlsx")
...
# df_reflections = df_reflections.groupby("cid").apply(lambda s: s.sort_values("time"))
...
df_processed_reflection.to_csv("../mydata/processed/processed_reflection.csv", index=False)
